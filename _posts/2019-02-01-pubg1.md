...
comments: true
published: true
title: WIP:Build a data pipeline on AWS to collect PUBG data
...
This data is accessible per Athena but you can connect aws quicksight ti have a more like Tableau like experience (what i don’t like I am not a big fan of all this BI tool that are too blackbox for me) and more important you can  access this data from a notebook in a machine with boto 3 install on your python environment.
